...
exports.acceptRequest = async (req, res) => {
  try {
    ...
    const requestId = req.params.requestId; // Request ID to accept
    ...
    return res.json({ success: true, msg: "Friend request accepted successfully" });
...
exports.rejectRequest = async (req, res) => {
  try {
    const userId = req.user.id; // Logged-in user (receiver)
    const requestId = req.params.requestId; // Request ID to reject
    ...
    return res.json({ success: true, msg: "Friend request rejected successfully" });
